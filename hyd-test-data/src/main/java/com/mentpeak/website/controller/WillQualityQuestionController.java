 ...
 */
@Controller
@RequestMapping("/will-quality-question")
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
@Api(value = "意志品质问卷接口", tags = "意志品质问卷接口")
public class WillQualityQuestionController {

    private final IWillQualityQuestionService questionService;

    @PostMapping("/import")
    @ApiOperation(value = "导入意志品质量表问卷")
