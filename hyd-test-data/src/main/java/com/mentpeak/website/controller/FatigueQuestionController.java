...
import com.mentpeak.website.service.IFatigueOptionService;
 ...
 */
@Controller
@RequestMapping("/fatigue-question")
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
@Api(value = "疲劳问卷接口", tags = "疲劳问卷接口")
public class FatigueQuestionController {

    private final IFatigueQuestionService questionService;

    @PostMapping("/import")
    @ApiOperation(value = "导入疲劳量表问卷")
